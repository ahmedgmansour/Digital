...
4- create a shell script that can upload a file into a minIO.
$ cd /
$ nano minio-upload.sh

 3- create a DockerFile for hello application that contaion shel script
 $ touch DockerFile
 $ docker build -t hello-application .

 $ docker login -u ahmedgmansour -p password 
 $ docker tag hello-application ahmedgmansour/hello-application
 $ docker push ahmedgmansour/hello-application
...
## run docker image (hello-application) on kubernetes
